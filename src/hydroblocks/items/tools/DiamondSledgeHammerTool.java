...
public class DiamondSledgeHammerTool extends Item {

	public DiamondSledgeHammerTool(int id) {
		super(id);
		setCreativeTab(hydroblocks.hydroblocks);
		setUnlocalizedName(Names.diamondsledgehammerTool_unlocalizedName);
	}
